...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_TInterface_t, stringdata) + ofs \
...
const QMetaObject TInterface::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_TInterface.data,
      qt_meta_data_TInterface,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_TInterface.stringdata))
        return static_cast<void*>(const_cast< TInterface*>(this));
